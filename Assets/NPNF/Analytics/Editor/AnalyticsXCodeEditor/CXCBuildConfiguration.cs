...
//				Debug.Log( "adding: " + currentPath );
		...
		public bool AddOtherBuildSetting(string key, object value)
		{
			bool modified = false;
			...
			PBXDictionary buildSettings = (PBXDictionary)_data[BUILDSETTINGS_KEY];
			if( !buildSettings.ContainsKey( key ) || !buildSettings[key].Equals(value) ) {
...
// ADDED BY SL - see https://github.com/tuo/UnityAutomatePostProcess/blob/master/Assets/Editor/mod_pbxproj.py

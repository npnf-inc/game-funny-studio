...
namespace UnityEditor.NPNFEditor 
{
	public class XCMod 
	{
		...
		{	
			...
			Dictionary<string, object> dictJson = NPNF.Lib.MiniJSON.Json.Deserialize(contents) as Dictionary<string,object>;;

			try{
			_datastore = new Hashtable(dictJson);
			}catch(System.ArgumentNullException)
			{
				throw new System.ArgumentNullException("projpath: " + projectPath +" filename: " +  filename);
			}
		}
	}
